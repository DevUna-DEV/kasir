        ...
        <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
            <div class="d-flex flex-column align-content-end">
                <div class="app-auth-body mx-auto">
                    ...
                    <h2 class="auth-heading text-center mb-5">Login to Kampung Kecil Restaurant</h2>
                ...
                <div class="d-flex flex-column align-content-end h-100">
                    ...
                    <div class="overlay-content p-3 p-lg-4 rounded">
                        <h5 class="mb-3 overlay-title">
                            Motivasi untuk hari ini</h5>
                        <div>Tugas kita tidak hanya menyajikan makanan yang lezat tetapi juga memberikan pelayanan yang
                            ramah dan efisien. Fokus pada kualitas layanan yang baik dan kesuksesan akan mengikuti</div>
                    </div>
                </div>
            </div>
        </div>
